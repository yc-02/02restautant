import HomeNav from "@/app/(homepage)/HomeNav"
...
export default function Home() {
  ...
  return (
    ...
    <main>
      ...
      <Image className="rounded" src={food1} alt="food1"/>
      <Image className="rounded" src={food2} alt="food2"/>
      <Image className="rounded" src={food3} alt="food3"/>
      </div>
      <div className="grid gap-5">
      <Image className="rounded" src={food4} alt="food4"/>
      <Image className="rounded" src={food5} alt="food5"/>
      </div>
      </div>
      </div>
    </main>
