...
export default async function DetialPage({params}:{params:ReservationDetailsParams}){
    ...
    return(
        ...
        <div className="grid md:grid-cols-2 content-center items-center py-5 bg-slate-100">

        <div className="m-auto rounded w-72 flex flex-col gap-7">
        ...
        <p><span className="font-bold">Party size: </span>{data?.party}</p>
